...
fem_exp <- ggplot(data, aes(x = exp.female)) +
  ...
  scale_y_continuous(name = "Participants", breaks = c(0, 25, 50, 75)) +
  scale_x_continuous(name = "Female Session Attendance", limits = c(-1.25, 15)) +
...
m_exp <- ggplot(data, aes(x = exp.male)) +
  ...
  # geom_density(adjust = 2) +
  scale_y_continuous(name = "Participants", breaks = c(0, 25, 50, 75)) +
  scale_x_continuous(name = "Male Session Attendance", limits = c(-1.25, 15)) +
  coord_cartesian(clip = "off", xlim = c(0, 15), ylim = c(0, 90)) +
...
# save plot
ggsave("fin_figs/fig3.pdf", width = 5, height = 3)
# embed the font
embed_fonts("fin_figs/fig3.pdf")
```
## Figure 3 Panels
