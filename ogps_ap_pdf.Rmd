...
pdf("figs/fig5.pdf", height = 3.5, width = 7)
...
# Figure 6 - Dose Response Plot

```{r fig5, warning=FALSE, fig.width=7, fig.height=4, eval = FALSE}
# females
# ols
...
fem_pp_plot <- ggplot(fem_pp) +
  ...
  geom_point(aes(x = predicted, y = x_new, color = IPW), size = 1) +
  scale_color_manual(name = "", values = c("#606060", "#919191", "#C4C4C4")) +
  scale_fill_manual(name = "", values = c("#606060", "#919191", "#C4C4C4")) +
...
# save plot
ggsave("figs/fig6.pdf", width = 7, height = 4)
# embed the font
